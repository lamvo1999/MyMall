...
public class AddressesAdapter extends RecyclerView.Adapter<AddressesAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull AddressesAdapter.ViewHolder viewHolder, int position) {
        String name = addressesModelList.get(position).getFullnamr();
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        private void setData(String username, String userAddress, String Pincode, Boolean selected, final int position){
